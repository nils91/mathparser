...
public class SymbolicBinomialEquationTests {
	@BeforeAll
	...
	public void testSymbolicCorrectnessFirstBinomialEquation(String equation) {
	...
	public void testSymbolicCorrectnessSecondBinomialEquation(String equation) {
		assertTrue(SymbolicEqualityUtil.checkSymbolicEquality(equation, SymbolicEqualityUtil.buildSimplificationRule()));	
	}
	...
	public void testSymbolicCorrectnessThirdBinomialEquation(String equation) {
		assertTrue(SymbolicEqualityUtil.checkSymbolicEquality(equation, SymbolicEqualityUtil.buildSimplificationRule()));
	}
}
